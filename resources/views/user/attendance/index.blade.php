...
<div class="main-wrap">
  <div id="clock" class="light">
    <div class="display">
      ...
      @elseif($attendance->absence_state === 1)
        <div class="button-holder">
  ...
  <ul class="button-wrap">
    <li>
      <a class="at-btn absence" href="{{ route('attendance.storeAbsence') }}">欠席登録</a>
    </li>
    <li>
...
<div id="openModal" class="modalDialog">
  <div>
    ...
    @elseif (!empty($attendance->start_time) && empty($attendance->end_time))
      {!! Form::open(['route' => ['attendance.storeEndTime', $attendance->id], 'method' => 'PUT']) !!}
