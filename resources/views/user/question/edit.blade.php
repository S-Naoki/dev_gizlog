  ...
  <div class="container">
    ...
    {!! Form::hidden('question_id', $question->id) !!}
      <div class="form-group @if(!empty($errors->has('tag_category_id'))) has-error @endif">
        {!! Form::select('tag_category_id', ['Select category', 'front', 'back', 'infra', 'others'], $question->tagCategory->id, ['class' => 'form-control selectpicker form-size-small', 'id' => 'pref_id']) !!}
